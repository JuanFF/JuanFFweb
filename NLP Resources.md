...
<p class = 'commonP'>
	...
	<br /><br />
	Both entities must be semantically related to be well labeled. This <i>entity-treats-entity</i> relationship must be explicit in text; otherwise, NER will return an <code>&lt;empty&gt;</code> tag.<br /><br />
...
<p class = 'commonP'>
	...
	This is a text classifier that categorizes user names and descriptions from Twitter accounts related to health and medicine.
...
<div class="mySlides fade">
  <img src="assets/resources/institution.png" style="width:100%">
  <div class="text">Institution</div>
</div>

<div class="mySlides fade">
  <img src="assets/resources/association.png" style="width:100%">
  <div class="text">Association</div>
</div>

<div class="mySlides fade">
  <img src="assets/resources/business.png" style="width:100%">
  <div class="text">Business</div>
</div>

<div class="mySlides fade">
  <img src="assets/resources/initiative.png" style="width:100%">
  <div class="text">Initiative</div>
</div>

<div class="mySlides fade">
  <img src="assets/resources/institution2.png" style="width:100%">
  <div class="text">Institution</div>
</div>

<div class="mySlides fade">
  <img src="assets/resources/news.png" style="width:100%">
  <div class="text">News</div>
</div>

<div class="mySlides fade">
  <img src="assets/resources/publishing.png" style="width:100%">
  <div class="text">Journal</div>
</div>

<div class="mySlides fade">
  <img src="assets/resources/academia.png" style="width:100%">
...
<p class = 'commonP'>
  <br /><br />As Twitter users provide information on themselves in their user names and descriptions, the classifier reads from this data (name, description) to return a descriptive label for each profile. This is the current classifier's tag set:
...
<p class= 'commonP'>
	...
	In all cases, the classifier must receive the Twitter user name and description as input data. If the input profile doesn't belong to any of these categories, it returns <code>&lt;empty&gt;</code>.<br /><br />

	User profile classification may be useful when managing loads of health information on Twitter. The classifier's precision score is 0.86<br /><br />
...
<p class = 'commonP'>
  ...
  User names were omitted. You can use this data to train machine learning models based on Twitter's valuable health information sources.<br/><br/>
